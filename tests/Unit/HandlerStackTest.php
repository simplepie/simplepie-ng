...
class HandlerStackTest extends AbstractTestCase
{
    ...
    {
        $stack = (new HandlerStack())
            ->appendClosure(FeedType::ALL, function () {}, 'start')
            ->appendClosure(FeedType::JSON, function () {}, 'appendJson')
            ->appendClosure(FeedType::HTML, function () {}, 'appendHtml')
            ->appendClosure(FeedType::XML, function () {}, 'appendXml')
            ->prependClosure(FeedType::JSON, function () {}, 'prependJson')
            ->prependClosure(FeedType::HTML, function () {}, 'prependHtml')
            ->prependClosure(FeedType::XML, function () {}, 'prependXml');
