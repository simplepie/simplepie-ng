...
class EntrySummaryTest extends AbstractTestCase
{
    ...
    {
        $stream = $this->getFeed('/wellformed/lang/entry_summary_xml_lang.xml');
    ...
    {
        $stream = $this->getFeed('/wellformed/lang/entry_summary_xml_lang_blank.xml');
        $parser = $this->simplepie->parseXml($stream);
        $feed   = $parser->getFeed();
    ...
    {
        $stream = $this->getFeed('/wellformed/lang/entry_summary_xml_lang_inherit.xml');
        $parser = $this->simplepie->parseXml($stream);
        $feed   = $parser->getFeed();
    ...
    {
        $stream = $this->getFeed('/wellformed/lang/entry_summary_xml_lang_inherit_2.xml');
        $parser = $this->simplepie->parseXml($stream);
        $feed   = $parser->getFeed();
    ...
    {
        $stream = $this->getFeed('/wellformed/lang/entry_summary_xml_lang_inherit_3.xml');
        $parser = $this->simplepie->parseXml($stream);
        $feed   = $parser->getFeed();
    ...
    {
        $stream = $this->getFeed('/wellformed/lang/entry_summary_xml_lang_inherit_4.xml');
        $parser = $this->simplepie->parseXml($stream);
        $feed   = $parser->getFeed();
